function performCustomerBuy(){
    let url = "http://localhost:8081/addressservice/addresses"
    ...
    axios.post(url, (
        ...
        .then(response => {
            ...
            url = "http://localhost:8081/paymentservice/payments";
            axios.post(url, (
                {
                    'PaymentRequest': {
                        'customerID': customerID,
            ...
            .then(response => {
                ...
                const url = "http://localhost:8081/orderservice/orders"
                console.log(prodID);
                axios.post(url, (
                    {
                        'OrderRequest': {
                    ...
                    .then(response => {
                        console.log('response status', response.status);
                        window.location.href = "http://localhost:8082/order.html?orderID=" + response.data.Order.orderID;
                    })
                    .catch(error => {
